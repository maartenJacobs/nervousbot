...
#
#     PHX_SERVER=true bin/nervous_bot start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :nervous_bot, NervousBotWeb.Endpoint, server: true
end

# Configure your database
config :nervous_bot, NervousBot.Repo,
  database: "priv/db/nervous_bot_#{config_env()}#{System.get_env("MIX_TEST_PARTITION")}.db",
  stacktrace: true,
...
if config_env() == :prod do
  ...
  #
  #     config :nervous_bot, NervousBot.Mailer,
